...
INSERT INTO `dosen` (`id_dosen`, `nidn`, `nama_dosen`, `gelar`, `email`, `nomor_telepon`, `password`, `created_at`) VALUES
(1, 'DOS001', 'Dr. Ahmad Wijaya', 'S.Kom., M.Kom.', 'ahmad.wijaya@touhou.ac.id', '081234567890', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(2, 'DOS002', 'Prof. Siti Nurhaliza', 'S.T., M.T., Ph.D.', 'siti.nurhaliza@touhou.ac.id', '081234567891', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(3, 'DOS003', 'Dr. Budi Santoso', 'S.Mat., M.Mat.', 'budi.santoso@touhou.ac.id', '081234567892', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(4, 'DOS004', 'Lisa Permata', 'S.Kom., M.T.', 'lisa.permata@touhou.ac.id', '081234567893', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24');
...
(7, 4, 1, '2025-06-24 14:36:31', NULL, NULL, 'Aktif', '2025-06-24 06:36:31');
...
INSERT INTO `mahasiswa` (`id_mahasiswa`, `nim`, `nama`, `tanggal_lahir`, `jenis_kelamin`, `alamat`, `nomor_telepon`, `email`, `foto`, `password`, `created_at`) VALUES
(1, '2021001234', 'John Doe', '2003-05-15', 'L', 'Jl. Merdeka No. 123, Jakarta', '081234567894', 'john.doe@student.touhou.ac.id', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(2, '2021001235', 'Jane Smith', '2003-08-20', 'P', 'Jl. Sudirman No. 456, Bandung', '081234567895', 'jane.smith@student.touhou.ac.id', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(3, '2022001236', 'Ahmad Rahman', '2004-02-10', 'L', 'Jl. Diponegoro No. 789, Surabaya', '081234567896', 'ahmad.rahman@student.touhou.ac.id', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-06-23 14:32:24'),
(4, '1', 'a', '2025-06-24', 'L', 'a', '08129', 'a@gmail.com', NULL, '$2y$10$pOu5ZaTFZaaxY9ofBIlql.uTNeQqUHcKtqG8BP4ByTGIaPwQiz2Yy', '2025-06-23 17:53:44');
...
INSERT INTO `mata_kuliah` (`id_matakuliah`, `kode_matakuliah`, `nama_matakuliah`, `sks`, `semester`, `deskripsi`, `created_at`) VALUES
(1, 'MK001', 'Algoritma dan Pemrograman', 3, 1, 'Mata kuliah dasar pemrograman dan algoritma', '2025-06-23 14:32:24'),
(2, 'MK002', 'Struktur Data', 3, 2, 'Mata kuliah tentang struktur data dan implementasinya', '2025-06-23 14:32:24'),
(3, 'MK003', 'Basis Data', 3, 3, 'Mata kuliah tentang sistem basis data relasional', '2025-06-23 14:32:24'),
(4, 'MK004', 'Pemrograman Web', 3, 4, 'Mata kuliah tentang pengembangan aplikasi web', '2025-06-23 14:32:24'),
(5, 'MK005', 'Kalkulus I', 4, 1, 'Mata kuliah matematika dasar untuk informatika', '2025-06-23 14:32:24'),
(6, 'MK006', 'Statistika', 3, 2, 'Mata kuliah tentang statistika dan probabilitas', '2025-06-23 14:32:24'),
(7, 'MK007', 'Jaringan Komputer', 3, 5, 'Mata kuliah tentang konsep dan implementasi jaringan', '2025-06-23 14:32:24'),
(8, 'MK008', 'Rekayasa Perangkat Lunak', 3, 6, 'Mata kuliah tentang metodologi pengembangan software', '2025-06-23 14:32:24');
