        ...
        <div class="w-64 p-4">
            <div class="sidebar-soft h-full p-4">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="dashboard-soft.php" class="nav-link-soft active flex items-center text-white">
            ...
            <div class="card">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="krs-soft.php" class="flex flex-col items-center p-4 bg-gradient-primary rounded-xl text-white hover:shadow-lg transition-all duration-200">
                            <i class="fas fa-book text-2xl mb-2"></i>
                            <span class="text-sm font-medium">Isi KRS</span>
                        </a>
                        
                        <a href="jadwal-soft.php" class="flex flex-col items-center p-4 bg-gradient-success rounded-xl text-white hover:shadow-lg transition-all duration-200">
                            <i class="fas fa-calendar text-2xl mb-2"></i>
                            <span class="text-sm font-medium">Jadwal</span>
                        </a>
                        
                        <a href="transkrip-soft.php" class="flex flex-col items-center p-4 bg-gradient-info rounded-xl text-white hover:shadow-lg transition-all duration-200">
                            <i class="fas fa-file-alt text-2xl mb-2"></i>
                            <span class="text-sm font-medium">Transkrip</span>
                        </a>
                        
                        <a href="profil-soft.php" class="flex flex-col items-center p-4 bg-gradient-warning rounded-xl text-white hover:shadow-lg transition-all duration-200">
