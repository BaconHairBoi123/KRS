...
<head>
    ...
    * {
    ...
    .login-form-container {
        ...
        max-height: 90vh;
        overflow-y: auto;
        /* Ubah kembali ke auto untuk handle error state */
    ...
    @media (max-width: 768px) {
        ...
        .login-form-container {
            ...
            max-height: 55vh;
            overflow-y: auto;
            /* Pastikan bisa scroll di mobile */
        }
        ...
        .login-form-container.has-error {
            max-height: 58vh;
            /* Sedikit lebih tinggi saat ada error */
        }
    }
    ...
    @media (max-width: 480px) {
        ...
        .login-form-container.has-error {
            max-height: 62vh;
            /* Lebih tinggi untuk small mobile dengan error */
        }
    ...
    <div class="login-container">
        ...
        <div class="video-section">
            <video class="university-video" autoplay muted loop>
                <source src="assets/videos/kodok lompat acumalaka.mp4" type="video/mp4">
            ...
            <div class="video-content">
                <div class="mb-8">
                    ...
                    <p class="text-xl opacity-90 max-w-md mx-auto">
                        Bergabunglah dengan ribuan mahasiswa dalam perjalanan pendidikan digital yang inovatif dan
                        modern.
                    </p>
                </div>
            ...
            <div class="login-form-container <?php echo $error ? 'has-error' : ''; ?>">
                ...
                <form method="POST">
                    <div class="form-group">
                        <input type="text" name="nim" class="form-input" placeholder="NIM" required
