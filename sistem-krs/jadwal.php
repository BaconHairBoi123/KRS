...
// Get mahasiswa ID
$query = "SELECT id_mahasiswa FROM mahasiswa WHERE id_mahasiswa = :user_id";
...
foreach ($jadwal_kuliah as $jadwal) {
    $hari = $jadwal['hari'] ?: 'Belum Dijadwalkan';
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-xl">
                                <i class="fas fa-calendar text-blue-600"></i>
                                <span class="text-sm font-medium text-blue-800">Total:
                                    <?php echo count($jadwal_kuliah); ?> Mata Kuliah</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    <?php echo isset($jadwal_per_hari[$hari]) ? count($jadwal_per_hari[$hari]) : 0; ?>
                                    mata kuliah
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2 mb-2">
                                            <span
                                                class="text-xs font-semibold bg-white bg-opacity-20 px-2 py-1 rounded">
                                                <?php echo $jadwal['kode_matakuliah']; ?>
                                            </span>
                                            <span
                                                class="text-xs font-semibold bg-white bg-opacity-20 px-2 py-1 rounded">
                                        ...
                                        <h4 class="font-semibold text-white mb-1">
                                            <?php echo $jadwal['nama_matakuliah']; ?></h4>
                                        <p class="text-sm text-white text-opacity-90">
                                            <?php echo $jadwal['nama_dosen']; ?></p>
                                    </div>
                                </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="text-center p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl">
                            <div class="text-2xl font-bold text-green-600">
                                <?php echo array_sum(array_column($jadwal_kuliah, 'sks')); ?></div>
                        ...
                        <div class="text-center p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl">
                            <div class="text-2xl font-bold text-purple-600">
                                <?php echo count(array_filter($jadwal_per_hari)); ?></div>
                        ...
                        <div class="text-center p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl">
                            <div class="text-2xl font-bold text-orange-600">
                                <?php echo count(array_unique(array_column($jadwal_kuliah, 'nama_dosen'))); ?></div>
