...
if ($_POST && isset($_POST['action'])) {
    if ($_POST['action'] == 'add_kelas') {
        ...
        try {
            ...
            $check_stmt->bindValue(':id_mahasiswa', $userData['id']);
            ...
            if ($capacity_data['terisi'] >= $capacity_data['kapasitas']) {
            ...
            $insert_stmt->bindValue(':id_mahasiswa', $userData['id']);
        ...
        try {
            ...
            $delete_stmt->bindValue(':id_mahasiswa', $userData['id']);
            $delete_stmt->execute();
...
$krs_stmt->bindValue(':id_mahasiswa', $userData['id']);
$krs_stmt->execute();
...
<head>
    ...
    <title>Kartu Rencana Studi - Universitas Touhou</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Sistem Pengambilan Mata Kuliah - Universitas Touhou</p>
