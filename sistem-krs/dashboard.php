...
if (getUserRole() == 'mahasiswa') {
    // Get mahasiswa stats using new database structure
    $query = "SELECT m.*, 
    ...
    $stmt->bindValue(':nim', $_SESSION['nim']);
    $stmt->execute();
    ...
    $stats = [
        ...
        'nama' => $mahasiswa_data['nama'] ?? $_SESSION['nama'],
        'nim' => $mahasiswa_data['nim'] ?? $_SESSION['nim']
    ];
}
?>
                    ...
                    <div class="bg-white bg-opacity-50 rounded-xl p-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500"><?php echo $_SESSION['nim']; ?></p>
                            </div>
